...
import { formatOnePayAmount } from "../formatters";

type ApproveExecutionModalProps = {
  isOpen: boolean;
  transfer: OnePayTransfer | null;
...
export default function ApproveExecutionModal({
  ...
  const t = useTranslations("onePayTransfer.approvalModal");
  ...
  const amount = formatOnePayAmount(transfer.amount, locale);
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="onepay-approval-title"
    >
      <div className="w-full max-w-lg overflow-hidden rounded-2xl bg-white shadow-2xl">
        <div className="flex items-center justify-between border-b bg-slate-50 px-6 py-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 id="onepay-approval-title" className="text-lg font-bold text-slate-900">
                {t("title")}
              </h2>
