...
export type OnePayActionName = "approve" | "refresh" | null;

type OnePayRowActionsProps = {
  transfer: OnePayTransfer;
  canApprove: boolean;
  loadingAction?: OnePayActionName;
  showView?: boolean;
  variant?: "icon" | "header";
  onView: () => void;
  onApprove: () => void;
...
export default function OnePayRowActions({
  transfer,
  canApprove,
  loadingAction = null,
  showView = true,
  ...
  onApprove,
  onRefresh,
}: OnePayRowActionsProps) {
  const t = useTranslations("onePayTransfer.actions");
