...
export default function VerifiedRecipientModal({
  ...
  const t = useTranslations("onePayTransfer.validationModal");
  ...
  const amount = formatOnePayAmount(validation.amount, locale);
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="onepay-validation-title"
    >
      <div className="w-full max-w-xl overflow-hidden rounded-2xl bg-white shadow-2xl">
        <div className="flex items-center justify-between border-b bg-gradient-to-r from-emerald-50 to-blue-50 px-6 py-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 id="onepay-validation-title" className="text-xl font-bold text-slate-900">
                {t("title")}
              </h2>
            ...
            {validation.expiresAt && (
              <div className="sm:col-span-2">
                ...
                <dd className="text-slate-900">
                  {formatOnePayDateTime(validation.expiresAt, locale)}
                </dd>
              </div>
            )}
          </dl>
